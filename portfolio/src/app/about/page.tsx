    ...
    <main className="px-6 py-32 md:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 space-y-6 text-lg text-foreground/80">
          <p>
            Hi, I'm Jinendra Shah, a full-stack developer and machine learning enthusiast based in Mumbai. 
          ...
          <p>
            Currently, I'm pursuing my studies while actively seeking internship opportunities where 
