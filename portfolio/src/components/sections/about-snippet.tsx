  ...
  return (
    <section className="px-6 py-24 md:px-12">
      <p className="mx-auto max-w-2xl text-lg text-foreground/80">
        I'm a full-stack developer and machine learning enthusiast currently pursuing my studies in Mumbai. 
        I specialize in building modern web applications with React and Next.js while exploring the intersection 
        of web development and artificial intelligence. My work focuses on creating accessible, performant, 
